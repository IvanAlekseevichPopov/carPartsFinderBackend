...
final class Version20230305172405 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Added part-related tables and users';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car_model (id SERIAL NOT NULL, brand_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, external_id INT NOT NULL, children_parts_parsed BOOLEAN DEFAULT false NOT NULL, production_start DATE DEFAULT NULL, production_finish DATE DEFAULT NULL, modifications JSONB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE part (id UUID NOT NULL, part_name_id INT DEFAULT NULL, brand_id INT DEFAULT NULL, part_number VARCHAR(255) NOT NULL, suitable_for_models JSONB NOT NULL, images_to_parse JSONB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE part_image (id UUID NOT NULL, part_id UUID DEFAULT NULL, uploaded_by_id UUID DEFAULT NULL, check_sum VARCHAR(255) NOT NULL, rating INT DEFAULT NULL, PRIMARY KEY(id))');
